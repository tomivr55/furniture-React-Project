    ...
    <div className={style.furnitureDetails}>
      ...
      <div className={style.detailsDescriotion}>
        <p className={style.whd}>
          ...
          Eveniet voluptas veniam officia neque adipisci et animi quis
          voluptate, asperiores nesciunt ex dignissimos, ad nihil deserunt ipsam
          quaerat inventore explicabo sunt?
        </p>
      </div>
